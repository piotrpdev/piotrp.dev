...
image: ~/assets/images/blog/arduino-discord-controller/thumb.webp
category: Projects
tags:
  - arduino
  - desktop
...
import frontImg from '~/assets/images/blog/arduino-discord-controller/front.webp';
import backlightingImg from '~/assets/images/blog/arduino-discord-controller/backlighting.webp';
import quadrantImg from '~/assets/images/blog/arduino-discord-controller/quadrant.webp';
import keysFullImg from '~/assets/images/blog/arduino-discord-controller/keys/full.png';
import pythonConsoleImg from '~/assets/images/blog/arduino-discord-controller/python_console.webp';
import discordConsoleImg from '~/assets/images/blog/arduino-discord-controller/discord_console.png';
...
<PostMedia alt="front of the cockpit" src={frontImg.src} arr="2022 The Warthog Project">
Front of the cockpit, taken from <ExtLink href="https://thewarthogproject.com/gallery">thewarthogproject.com</ExtLink>.
</PostMedia>

<PostMedia alt="backlighting" src={backlightingImg.src} arr="2022 The Warthog Project">
...
<PostMedia alt="simple throttle levers" src={quadrantImg.src}>
...
<PostMedia alt="keyboard layout" src={keysFullImg.src} wc="ANSI_Keyboard_Layout_Diagram_with_Form_Factor.svg" cc="3">
Diagram by Rumudiez,
</PostMedia>
...
<PostMedia alt="python log" src={pythonConsoleImg.src}>
Python log.
</PostMedia>

<PostMedia alt="discord log" src={discordConsoleImg.src}>
Discord log.
</PostMedia>
...
<div class="media-container">
    <figure>    
        <video class="media" controls muted>
            <source
            src="/assets/blog/arduino-discord-controller/old_demo.mp4"
            type="video/mp4" />
        </video>
    </figure>
...
<div class="media-container">
    <figure>    
        <video class="media" controls muted>
            <source
            src="/assets/blog/arduino-discord-controller/new_demo.mp4"
            type="video/mp4" />
        </video>
    </figure>
