...
image: ~/assets/images/blog/pc-specs/thumb.webp
category: Projects
tags:
  - web
  - desktop
...
import jokeImg from '~/assets/images/blog/pc-specs/joke.webp';
...
<PostMedia alt="sun position" arr="2019 DevRage" src={jokeImg.src}>
...
<div class="hide-on-mobile">
    <DoubleBar client:only="svelte" className="small" title="With Extension vs Without Extension" xCallback={xCallback} yTitle="Size (MB)" data={totalsBarData} />
</div>
